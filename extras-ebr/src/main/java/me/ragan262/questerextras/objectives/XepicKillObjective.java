...
@QElement("XEPICKILL")
public class XepicKillObjective extends Objective {

	private final List<String> mobs;
	private final String mobString;
	private final int amount;

	public XepicKillObjective(List<String> mobs, int amount) {
	...
	public static Objective fromCommand(final QuesterCommandContext context)
		...
		return new XepicKillObjective(mobs, amount);
	}
	...
	protected static Objective load(final StorageKey key) {
		...
		return new XepicKillObjective(mobs, amt);
	}
}
